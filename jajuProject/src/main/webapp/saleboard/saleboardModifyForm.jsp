...
<html>
<head>
<link rel="stylesheet" href="/jaju/css/saleboardModifyForm.css" />
<meta charset="UTF-8">
...
<table class="saleboardModifyTable" id="saleboardModifyTable" style="width:100%;">
...
<tr>
		 	<th class="saleboardModifyTd" align="left" >판매가격</th>
		 	<td class="saleboardModifyTd" colspan="2">
...
<tr>
<th class="saleboardModifyTd">이전 이미지</th>
<td class="saleImg" name="img[]" style="position: relative; width:70%;">
	...
	<tbody>
		<tr>
			<td align="right" style="padding-top:5px; border:none;" id="avoidDbl">
				<input type="button" id="saleboardModifyBtn" class="bhs_button yb" value="판매글등록" style="float:none;">
			</td>
		</tr>
	</tbody>
</table>
