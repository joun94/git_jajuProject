...
<link rel="stylesheet" href="/jaju/css/review_saleReport.css" />
<style type="text/css">
*, *:after, *:before {
...
.list_order .deal_name a {
	display: block;
	overflow: hidden;
	background: url() no-repeat 100% 1px;
	font-size: 16px;
	line-height: 24px;
	font-weight: 700;
	color: #000;
...
<jsp:include page="/freeboard/boardMenu.jsp"/>
	...
	<div class="section_review">
		...
		<div class="tabTable" align="left" id="tabTable">
			<!-- 동적 태그 들어오는 곳  -->
				<table border="1" id="myBuyRecordTable" cellpadding="5" width="750px" bordercolor="#ededed" align="center" frame="hsides" rules="rows">
					<tr class="title">
				</tr>
			</table>
		</div>
